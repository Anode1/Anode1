...
| (*) Artifact Promotion as a Control Model for Stable Cloud Deployment ([ControlModel](https://github.com/Anode1/articles/tree/main/ControlModel)) | [10.5281/zenodo.20451078](https://doi.org/10.5281/zenodo.20451078) (the control-model note), [10.5281/zenodo.20528904](https://doi.org/10.5281/zenodo.20528904) (the implementation case study, with Enkli Ylli; the arXiv submission) |
...
| Conditional Probability in Diagnostic Testing: An Isomorphism Between Tree Diagrams, Bayes' Theorem, Contingency Tables and ARR/RRR ([ConditionalProbability](https://github.com/Anode1/articles/tree/main/ConditionalProbability)) | [10.5281/zenodo.20449608](https://doi.org/10.5281/zenodo.20449608); declined by medRxiv (affiliation policy), rejected by Advances in Health Sciences Education |
